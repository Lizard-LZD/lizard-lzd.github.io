...
export default function Skills({}: Props) {
  return (
    ...
    <h3 className='absolute top-4 uppercase tracking-[20px] text-gray-500 text-2xl'>Skills</h3>

    <h3 className='absolute top-12 uppercase tracking-[3px] text-gray-500 text-sm'>
